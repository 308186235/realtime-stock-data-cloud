<template>
    <view :class="['container', isDarkMode ? 'dark-theme' : 'light-theme']">
        <view class="header">
            <view class="title">股票交易系统</view>
            <view class="subtitle">智能选股 · 量化交易 · AI分析</view>
        </view>
        
        <!-- 高级功能卡片 -->
        <view class="premium-features">
            <view class="feature-card ai-feature" @click="navigateTo('/pages/agent-analysis/index')">
                <view class="feature-icon ai-icon"></view>
                <view class="feature-content">
                    <text class="feature-title">Agent智能交易</text>
        ...
        <view class="feature-shortcuts">
            <view class="shortcut-row">
                <view class="shortcut-item" @click="navigateTo('/pages/agent-analysis/index')">
            ...
            <view class="shortcut-row">
                <view class="shortcut-item" @click="navigateTo('/pages/trade/index')">
                    ...
                    <text class="shortcut-text">交易中心</text>
                </view>
                ...
                <view class="shortcut-item" @click="navigateTo('/pages/auto-trader/index')">
                    ...
                    <text class="shortcut-text">T+0交易</text>
                </view>
            </view>
        </view>
