...
const envConfigs = {
  ...
  [ENV_TYPE.DEV]: {
    // API base URL - use IP address instead of localhost for better mobile compatibility
    apiBaseUrl: `http://${localIpAddress}:8000`,
    
    // WebSocket address
    wsUrl: `ws://${localIpAddress}:8000/ws`,
  ...
  [ENV_TYPE.PROD]: {
    ...
    // WebSocket address
    wsUrl: 'wss://api.prod.com/stock5/ws', // Fixed Chinese directory name in WebSocket URL
