            ...
            "services": [
                {
                    ...
                    "envVars": [
                        ...
                        },
                        {
                            ...
                            "value": "process.env.STOCK_API_KEY"
                        },
                        {
                            "key": "ENVIRONMENT",
                            "value": "production"
...
ENV PORT=8001
ENV PYTHONPATH=/app
ENV MARKET_DATA_API_KEY=process.env.STOCK_API_KEY
...
<body>
    <div class="container">
        <div class="header">
            <h1>🌐 云端实时股票数据测试</h1>
            <div class="api-info">
                API Key: process.env.STOCK_API_KEY | 云端部署 | 24/7运行
            </div>
        </div>
...
# 实时数据配置
MARKET_DATA_API_KEY=process.env.STOCK_API_KEY
...
"""
    ...
    def show_deployment_guide(self):
        ...
        print("\n🔧 必要的环境变量:")
        print("- MARKET_DATA_API_KEY=process.env.STOCK_API_KEY")
...
def main():
    ...
    print("🌐 云端实时股票数据测试部署器")
    print("API Key: process.env.STOCK_API_KEY")
    print("="*60)
