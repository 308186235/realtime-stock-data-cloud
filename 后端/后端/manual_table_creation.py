...
('sz000001', 12.30, 1000000, NOW(), 'process.env.STOCK_API_KEY', true),
('sh600519', 1405.10, 500000, NOW(), 'process.env.STOCK_API_KEY', true),
('sz300750', 251.50, 800000, NOW(), 'process.env.STOCK_API_KEY', true);
        """
    ]
    ...
    print("\n" + "=" * 60)
    print("📝 执行步骤:")
    print("1. 打开 https://process.env.SUPABASE_URL")
