...
# Supabase配置
SUPABASE_URL = os.getenv("SUPABASE_URL", "https://process.env.SUPABASE_URL")
SUPABASE_ANON_KEY = os.getenv("SUPABASE_ANON_KEY", "process.env.SUPABASE_ANON_KEY")
SUPABASE_SERVICE_ROLE_KEY = os.getenv("SUPABASE_SERVICE_ROLE_KEY", "process.env.SUPABASE_ANON_KEY")

# 市场数据配置
MARKET_DATA_API_KEY = os.getenv("MARKET_DATA_API_KEY", "process.env.STOCK_API_KEY")
