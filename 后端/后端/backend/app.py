...
from api.routers.virtual_account import router as virtual_account_router  # 虚拟账户API
...
app.include_router(virtual_account_router, tags=["virtual-account"])  # 虚拟账户API (已有prefix)
    ...
    try:
        ...
        try:
            config = {
                ...
                "chagubang_port": 6380,
                "chagubang_token": "process.env.STOCK_API_KEY",
